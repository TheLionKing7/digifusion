...
export const metadata = {
  ...
  // noindex — this is a human-readable HTML page, not the XML sitemap.
  // The XML sitemap is at /sitemap.xml (generated by app/sitemap.ts).
  // Keeping this page out of Google's index prevents the GSC
  // "HTML page submitted as XML sitemap" error.
