...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/blog/topics/ai-automation`,              lastModified: new Date(), changeFrequency: 'weekly',  priority: 0.85 },
    { url: `${BASE}/blog/topics/digital-business`,           lastModified: new Date(), changeFrequency: 'weekly',  priority: 0.85 },
    { url: `${BASE}/blog/topics/content-visibility`,         lastModified: new Date(), changeFrequency: 'weekly',  priority: 0.85 },
