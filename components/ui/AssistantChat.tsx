...
function getOneSignal(): OneSignalSDK | undefined {
...
// Framework knowledge, pricing, and methodology live server-side only (Aria agent).
// The client sends messages — never proprietary IP.
